  ...
  return (
    <SafeAreaView style={stylesHomeScreen.container}>
      ...
      <View style={stylesHomeScreen.categoryContainer}>
        ...
        <TouchableOpacity style={stylesHomeScreen.cardContainer} onPress={() => navigation.navigate("CapitalsHome")}>
          <CardComponent category="Capitals" image={CapitalsImage} ></CardComponent>
        </TouchableOpacity>

        <TouchableOpacity style={stylesHomeScreen.cardContainer} onPress={() => navigation.navigate("TraditionsHome")}>
          <CardComponent category="Traditions" image={TraditionsImage} ></CardComponent>
        </TouchableOpacity>

        <TouchableOpacity style={stylesHomeScreen.cardContainer} onPress={() => navigation.navigate("AnimalsHome")}>
